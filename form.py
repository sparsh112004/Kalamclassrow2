...
if(user_name=="xyz" and password=="12345"):
    ...
    responselower=input("Would you like to have any another course with same course lead:\nEnter '1' if yes\nEnter '2' if no\n")
    punctuality_level = responselower
    ...
    if (4<=overall_score<6):
        print("Your overall satisfaction score is : ",overall_score)
        print(name,", your experience was average we will consider your feedbackk in ",course_name," course and try making it better.\nTHANKYOU")
    if (6<=overall_score<8):
        print("Your overall satisfaction score is : ",overall_score)
        print("So your overall experience was good ",name,", we thank you for your positive feedback in ",course_name," course. We will try making it even better.\nTHANKYOU")
