...
response = input("The course substantially improved my knowledge level. (agree/strongly agree/disagree/neutral): ")
knowledge_improvement = response.lower()
print("Impact on knowledge level:", knowledge_improvement)
